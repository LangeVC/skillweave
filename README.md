...
[![Version](https://img.shields.io/badge/version-0.3.1-blue)](https://github.com/typelicious/skillweave/releases/tag/v0.3.1)
...
SkillWeave v0.3.1+ provides separate skill directories for each command with direct `/skillweave-*` prefixes for faster access.
