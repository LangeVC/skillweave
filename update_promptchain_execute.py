#!/usr/bin/env python3
"""Update promptchain-execute skill with Next Level features section."""

import sys

# Read the entire file
with open('skills/skillweave-promptchain-execute/SKILL.md', 'r') as f:
    lines = f.readlines()

# Find line index of "## Execution Process"
target_line = -1
for i, line in enumerate(lines):
    if line.strip() == '## Execution Process':
        target_line = i
        break

if target_line == -1:
    print('Could not find ## Execution Process heading')
    sys.exit(1)
...
# Write back
with open('skills/skillweave-promptchain-execute/SKILL.md', 'w') as f:
    f.writelines(new_lines)

print('Updated promptchain-execute skill with Next Level features section.')